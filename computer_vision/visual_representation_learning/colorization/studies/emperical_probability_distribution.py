...
def empirical_probability_distribution_plot(hist):
    ...
    axes.set(xticks=range(-120, 120 + 1, 10), yticks=range(-120, 120 + 1, 10))
    axes.tick_params(axis="x", labelrotation=90, labelsize=8)
    axes.tick_params(axis="y", labelsize=8)
    axes.invert_yaxis()
    axes.grid(axis="x", color="White", alpha=0.7, linestyle="--", linewidth=0.5)
    axes.grid(axis="y", color="White", alpha=0.7, linestyle="--", linewidth=0.5)
