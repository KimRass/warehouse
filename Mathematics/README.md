...
- Mode
	- <img src="https://latex.codecogs.com/png.image?\colorbox{black}{\color{white}\frac{\alpha-1}{\alpha+\beta-2}}"/>
	- <img src="https://latex.codecogs.com/png.image?\colorbox{white}{\color{black}\frac{\alpha-1}{\alpha+\beta-2}}"/>
	<img src="https://latex.codecogs.com/png.image?\colorbox{black}{\color{white}\frac{\alpha-1}{\alpha+\beta-2}}"/>
